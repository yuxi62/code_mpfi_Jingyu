...
if r"Z:\Jingyu\Code\Python" not in sys.path:
    sys.path.append(r"Z:\Jingyu\Code\Python")
if r"Z:\Yingxue\code\PythonMotionCorrectionGECO" not in sys.path:
    sys.path.append(r"Z:\Yingxue\code\PythonMotionCorrectionGECO")
...
if __name__ == "__main__":
    ...
    DFF_WINDOW_SIZE = 1800  # frames (60s at 30Hz)
    DFF_PERCENTILE = 10     # 10th percentile for baseline
    
    # Soma classification thresholds
    SOMA_THRESHOLDS = {
        'min_soma_roi_npix': 100,
        'max_soma_roi_npix': 600,
        'compactness_threshold_min': 0.1,
        'hollowness_threshold_min': 0.25,
        'area_threshold': 2000,
    ...
    # test recording
    # for rec_idx, rec in rec_lst.loc[(rec_lst['anm']=='AC310')&(rec_lst['date']=='20250819')].iterrows():
        anm_id = rec['anm']
        date = rec['date']
